...
@section('content')
    ...
    <div style="text-align: left; padding: 0 44px 44px;">
        ...
        <p style="font-size: 14px;">We are pleased to inform you that you have been invited to attend the APEC CEO Summit 2024.</p>
        ...
        <p style="font-size: 14px;">If you have any questions or need additional information, please get in touch with us at <a href="mailto:registration@apecceosummit2024.com" style="color: #00A2F3;">registration@apecceosummit2024.com</a>.</p>

        <p style="font-size: 14px; margin-bottom: 20px;">We are here to ensure you have a productive and enjoyable experience at the Summit!</p>
