...
@section('content')
    ...
    <div style="text-align: left; padding: 0 44px 44px;">
        <p style="font-size: 14px;">Thank you for expressing your interest in attending the APEC CEO Summit 2024. We are thrilled that you are considering joining us at the most important business event in the Asia-Pacific region. Your expression of interest is now under review.</p>
