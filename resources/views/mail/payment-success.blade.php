...
@section('content')
    ...
    <div style="text-align: left; padding: 0 44px 44px;">
        ...
        <p style="font-size: 14px; margin-bottom: 20px;">You now got access to new information in our website, including the accommodation alternatives and the option of sharing your flight details. If you would like to make use of our complimentary transfer service during the event, we highly encourage you to stay at one of the designated hotels and let us know your complete travel arrangements.</p>

        <div style="text-align: center; margin-bottom: 30px;">
            <a href="{{route('hotel')}}" style="color: #FFF; font-size: 13px; text-decoration: none; background-color: #75B42E; padding-bottom: 10px; padding-top: 10px; padding-left: 10px; padding-right: 10px; border-radius: 5px;">Book hotel and share your flight</a>
        </div>
