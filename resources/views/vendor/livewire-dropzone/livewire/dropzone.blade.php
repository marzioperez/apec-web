...
>
    <div class="flex flex-col items-start h-full w-full max-w-2xl justify-center bg-white">
        @if(! is_null($error))
            <div class="bg-red-50 p-4 w-full mb-4 rounded">
                <div class="flex gap-3 items-start">
                    ...
                    <h3 class="text-sm text-red-800 font-medium">{{ $error }}</h3>
                </div>
            </div>
        @endif
        ...
        <div @click="$refs.input.click()" class="w-full">
            <div>
                ...
                <div x-show="isDragging" class="flex items-center bg-gray-100 justify-center gap-2 py-8 h-full">
                    ...
                    <p class="text-md text-gray-600">Drop here to upload</p>
                </div>
            </div>
            <input
                    x-ref="input"
        ...
        <div class="dz-flex dz-items-center dz-gap-2 dz-text-gray-500 dz-text-sm dz-mt-2 hidden">
            @php
            ...
            return ({
                ...
                onDrop(e) {
                    ...
                    const args = ['upload', file, () => {
                        ...
                        _this.dispatch('upload-photo', file);
                    }, (error) => {
