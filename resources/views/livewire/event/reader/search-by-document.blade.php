<div class="p-6 border-2 border-gray-200 rounded-xl flex items-center relative">
    ...
    <form class="w-full py-6 px-10 block" wire:submit.prevent="search_document">
