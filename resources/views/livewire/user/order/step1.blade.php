    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div class="py-10 flex justify-center">
            <div class="sm:w-[650px] w-full">
                <h3 class="text-primary-dark font-semibold mb-3 text-2xl">Invoicing details</h3>
                <div class="my-8 px-5">
                    ...
                    <div class="flex justify-center items-center space-x-5 mb-6">
                        <button type="button" wire:click.prevent="change_voucher_type('{{\App\Concerns\Enums\Types::NATIONAL->value}}')"
                            class="btn {{($data['voucher_type'] === \App\Concerns\Enums\Types::NATIONAL->value ? 'btn-gray' : 'btn-white-outline')}}">Peruvians</button>
                    ...
                    @if($data['voucher_type'] === \App\Concerns\Enums\Types::NATIONAL->value)
                        <div class="form-group">
                            <label for="document_type">Select Preferred Proof of Payment*</label>
                        ...
                        @if($data['document_type'] === \App\Concerns\Enums\Types::INVOICE->value)
                            ...
                            <div class="form-group">
                                <label for="data.business_name">Company name*</label>
                                <div class="form-field">
                    ...
                    @if($data['voucher_type'] === \App\Concerns\Enums\Types::FOREIGNER->value)
                        <div class="form-group">
                            <label for="data.client">Company name*</label>
                            <div class="form-field">
                        ...
                        <div class="form-group">
                            <label for="data.id">Tax ID*</label>
                            <div class="form-field">
                    ...
                    <div class="form-group">
                        <label for="data.physical_address">Address*</label>
                        <div class="form-field">
                    ...
                    <div class="form-group">
                        <label for="data.email_address">Email*</label>
                        <div class="form-field">
                    ...
                    <div class="sm:my-8 my-6 flex justify-center space-x-6 items-center">
                        <a href="{{route('progress')}}" class="btn btn-secondary">Back</a>
                        <button type="button" class="btn btn-primary" wire:click.prevent="process">Proceed to payment</button>
                    </div>
                </div>
            </div>
        </div>
