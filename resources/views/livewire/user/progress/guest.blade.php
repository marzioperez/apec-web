<div x-data="{ step: {{$current_step}}}"
    ...
    <div x-show="step <= 1"><livewire:user.progress.guest.step1 :user="$user" :quantity="4" /></div>
    ...
    <div x-show="step === 4"><livewire:user.progress.step5 :user="$user" :quantity="4" :current="4" :complete="3" /></div>
</div>
