<div class="sm:py-10 py-10 relative bg-fixed bg-no-repeat bg-contain bg-left-bottom" style="background-image: url('{{asset("img/bg-sign-up-step-2.png")}}')">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div class="sm:py-10 py-6 flex justify-center">
            <div class="w-full">
                <div class="sm:grid grid-cols-12 gap-10">
                    <div class="sm:mb-0 mb-6 lg:col-span-6 col-span-full">
                        <div class="grid lg:grid-cols-3 grid-cols-4 gap-3">
                            @foreach($hotels as $hot)
                                <img src="{{url('storage/web/' . $hot['photo'])}}" class="w-full sm:mb-0 mb-2 cursor-pointer" x-on:click.prevent="$dispatch('show-hotel', {hotel: {{json_encode($hot)}} })">
                            @endforeach
                        </div>
                    </div>
