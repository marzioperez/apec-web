...
class MenuPolicy
{
    ...
    {
        return $admin->can('delete_any_c::m::s::menu');
    }
    ...
    {
        return $admin->can('restore_c::m::s::menu');
    }
    ...
    {
        return $admin->can('restore_any_c::m::s::menu');
    }
    ...
    {
        return $admin->can('replicate_c::m::s::menu');
    }
    ...
    {
        return $admin->can('reorder_c::m::s::menu');
    }
}
